...
import com.example.dailynews.classes.SearchTopics;
import com.example.dailynews.interfaces.TopicEventListener;

import java.util.ArrayList;

public class LeftRecyclerSearchTopicsAdapter extends RecyclerView.Adapter<LeftRecyclerSearchTopicsAdapter.SearchTopicsViewHolder> {
    static ArrayList<SearchTopics> searchTopicsArrayList;
    TopicEventListener listener;

    public LeftRecyclerSearchTopicsAdapter(ArrayList<SearchTopics> searchTopicsArrayList) {
